                ...
                <div class="container">
                    ...
                    <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                        ...
                        <div class="header-logo mr-10 d-none d-lg-flex">
                            <a href="{{route('home')}}">
                                <img alt="Logo" src="/assets/images/logo/rutin-logo.png" class="h-35px" />
                            </a>
                        </div>
                        <!--end::Logo-->
                        <!--begin::Header Menu-->
                            ...
                            <ul class="menu-nav">
                                ...
                                <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        <span class="menu-text">İşlemler</span>
                                                ...
                                                <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                    <ul class="menu-subnav">
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="{{route('adsdetails')}}" class="menu-link">
                                                                <i class="menu-bullet menu-bullet-dot">
                                                                    <span></span>
                                                                </i>
                                                                <span class="menu-text">İlan İçeriği</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                    ...
                    <div class="topbar">
                        <div class="dropdown mr-1 mr-lg-3" id="kt_quick_search_toggle">
                            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                <div class="btn btn-icon btn-circle btn-hover-light-primary btn-dropdown">
                        ...
                        <!--end::Search-->
                        <!--begin::Quick Actions-->
                        <div class="dropdown mr-1 mr-lg-3">
                            <!--begin::Toggle-->
                            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                <div class="btn btn-icon btn-circle btn-hover-light-primary btn-dropdown">
											<span class="svg-icon svg-icon-lg">
                        ...
                        <div class="topbar-item mr-1 mr-lg-3">
                            <div class="btn btn-icon btn-circle btn-hover-light-primary" id="kt_quick_panel_toggle">
										<span class="svg-icon svg-icon-lg">
                        ...
                        <!--end::Quick panel-->
                        <!--begin::Chat-->
                        <div class="topbar-item mr-1 mr-lg-5">
                            <div class="btn btn-icon btn-circle btn-hover-light-primary btn-clean" data-toggle="modal" data-target="#kt_chat_modal">
										<span class="svg-icon svg-icon-lg">
        ...
        <div class="navi navi-spacer-x-0 p-0">
            ...
            <span class="navi-item mt-2">
						<span class="navi-link">
							<a href="{{route('del')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-3 px-6">Sign Out</a>
						</span>
					</span>
            <!--end:Item-->
        </div>
