...
class SettingsModel extends Model
{
     ...
     */
    public function prepareSettings(): SettingsModel
    {
        return $this->find(1);
    }
     ...
     * @return SettingsModel
     */
    public function getSiteName(): SettingsModel
    {
        return $this->first(1,'siteName');
    }
    /**
     * @param array $columns
     */
    public function getSettings(array $columns = [])
    {
        return $columns ? $this->find(1, $columns) : $this->prepareSettings();
    }
